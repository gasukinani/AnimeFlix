...
export function AnimeDetails() {
  ...
  return (
    <div className="pb-24">
      <Helmet>
        <title>{`${anime.title} - Watch on AnimeFlix`}</title>
        <meta name="description" content={anime.synopsis ? anime.synopsis.slice(0, 160) + '...' : `Watch ${anime.title} online for free on AnimeFlix.`} />
        <meta property="og:title" content={`${anime.title} - Watch on AnimeFlix`} />
